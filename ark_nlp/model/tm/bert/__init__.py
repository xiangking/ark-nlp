...
from ark_nlp.processor.tokenizer.transformer import PairTokenizer as Tokenizer
from ark_nlp.processor.tokenizer.transformer import PairTokenizer as BertTMTokenizer
